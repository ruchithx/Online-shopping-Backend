...
class CartApplicationTests {
	...
	void shouldGetCartItems() {
		...
		var response = RestAssured.given()
				...
				.when()
				.get(baseUrl + "/{userId}","f0391ea5-aaa1-4d36-b15c-b4758b7bfc33");
	...
	void shouldAddItemToCart() {
		...
		String jsonBody = "{\n" +
				...
				"    \"price\": 999.99,\n" +
				"    \"quantity\": 1,\n" +
				"    \"userId\": \"f0391ea5-aaa1-4d36-b15c-b4758b7bfc33\",\n" +
	...
	void shouldUpdateItemQuantityInCart() {
		...
		String baseUrl = "http://localhost:8082/api/v1/cart/update/59"; // Replace with dynamic cartId if needed
	...
	void shouldDeleteCart() {
		...
		int cartId = 63; // Replace with a valid cart ID
